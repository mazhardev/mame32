...
export const instructions: GameInstructions = {
  objective: 'Slide numbered tiles together to merge matching pairs and build the biggest number you can.',
  howToPlay: [
  ...
  scoring: 'Each merge adds the value of the new tile to your score. Reaching the target tile awards a large bonus.',
  difficultyNotes:
