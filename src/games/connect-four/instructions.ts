...
export const instructions: GameInstructions = {
  objective: 'Drop discs into the grid and be the first to line up four of your colour horizontally, vertically or diagonally.',
  howToPlay: [
  ...
  scoring: 'Winning scores 100 plus a bonus for finishing quickly, multiplied by difficulty. A draw scores 25.',
  difficultyNotes:
