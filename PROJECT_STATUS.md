...
| Games playable | 103 of 252 catalogued |
...
<!-- games:start -->
**103 of 252 games playable.** Generated by `node scripts/update-status.mjs`; a game is ticked only when its folder registers a playable definition.
